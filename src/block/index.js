...
//  */
// registerBlockType( 'cgb/block-guten-card', {
// 	// Block name. Block names must be string that contains a namespace prefix. Example: my-plugin/my-custom-block.
// 	title: __( 'guten-card - CGB Block' ), // Block title.
// 	icon: 'shield', // Block icon from Dashicons → https://developer.wordpress.org/resource/dashicons/.
// 	category: 'common', // Block category — Group blocks together based on common traits E.g. common, formatting, layout widgets, embed.
// 	keywords: [
// 		__( 'guten-card — CGB Block' ),
// 		__( 'CGB Example' ),
...
// 	 */
// 	edit: ( props ) => {
// 		// Creates a <p class='wp-block-cgb-block-guten-card'></p>.
// 		return (
// 			<div className={ props.className }>
// 				<p>— Hello from the backend.</p>
// 				<p>
// 					CGB BLOCK: <code>guten-card</code> is a new Gutenberg block
// 				</p>
// 				<p>
// 					It was created via{ ' ' }
// 					<code>
...
const { __ } = wp.i18n;
const { icon } = wp.icons.mediaAndText;
